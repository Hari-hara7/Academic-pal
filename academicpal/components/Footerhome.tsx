          ...
          <div className="col-span-2">
            <div className="flex items-center gap-3 mb-4">
              <Image
                ...
                className="rounded"
              />
              <h2 className="text-xl lg:text-2xl font-bold font-poppins">
                Academic Pal
              </h2>
            </div>
            <p className="text-gray-400 text-sm lg:text-base leading-relaxed mb-4">
              Your all-in-one academic resource platform for B.Tech students.
              Notes, question banks, syllabus & more!
            </p>
