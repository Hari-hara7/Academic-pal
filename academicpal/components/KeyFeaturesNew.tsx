        ...
        <div className="relative z-10 max-w-7xl mx-auto">
          ...
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-400 max-w-3xl mx-auto leading-relaxed">
              Discover our comprehensive suite of tools designed to enhance your
              academic journey and boost your productivity.
            </p>
          </div>
            ...
            {features.map((feature, index) => {
              ...
              return (
                ...
                >
                  ...
                  <div
                    className="absolute bottom-8 left-8 w-1 h-1 bg-white/30 rounded-full animate-pulse opacity-0 group-hover:opacity-100"
          ...
          <div className="mt-20 text-center">
            ...
            <p className="text-gray-400 text-lg mb-8 max-w-2xl mx-auto">
              Join thousands of students who are already using AcademicPal to
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
              ...
              <Link href="/chat">
                <Button
                  variant="outline"
                  className="border-white/30 text-white hover:bg-white/10 px-8 py-3 rounded-full font-semibold transition-all duration-300 hover:scale-105"
                >
